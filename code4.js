...
{for(var i = 0, len = gdjs.ShopCode.GDBackObjects2.length ;i < len;++i) {
    gdjs.ShopCode.GDBackObjects2[i].hide();
}
}{for(var i = 0, len = gdjs.ShopCode.GDBackObjects2.length ;i < len;++i) {
    gdjs.ShopCode.GDBackObjects2[i].Activate(false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(7)) < runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber();
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Next"), gdjs.ShopCode.GDNextObjects2);
{for(var i = 0, len = gdjs.ShopCode.GDNextObjects2.length ;i < len;++i) {
    gdjs.ShopCode.GDNextObjects2[i].hide(false);
}
}{for(var i = 0, len = gdjs.ShopCode.GDNextObjects2.length ;i < len;++i) {
    gdjs.ShopCode.GDNextObjects2[i].Activate(true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Next"), gdjs.ShopCode.GDNextObjects2);
{for(var i = 0, len = gdjs.ShopCode.GDNextObjects2.length ;i < len;++i) {
    gdjs.ShopCode.GDNextObjects2[i].hide();
}
}{for(var i = 0, len = gdjs.ShopCode.GDNextObjects2.length ;i < len;++i) {
    gdjs.ShopCode.GDNextObjects2[i].Activate(false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
{for(var i = 0, len = gdjs.ShopCode.GDBackObjects1.length ;i < len;++i) {
    gdjs.ShopCode.GDBackObjects1[i].hide(false);
}
}{for(var i = 0, len = gdjs.ShopCode.GDBackObjects1.length ;i < len;++i) {
    gdjs.ShopCode.GDBackObjects1[i].Activate(true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
if (true)
{
{runtimeScene.getScene().getVariables().getFromIndex(5).setNumber((gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) / 16));
...
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(7).add(6);
}
{ //Subevents
...
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(7).sub(6);
}
{ //Subevents
gdjs.ShopCode.eventsList8(runtimeScene);} //End of subevents
}
...
gdjs.ShopCode.eventsList9(runtimeScene);
gdjs.ShopCode.GDShopTileObjects1.length = 0;
gdjs.ShopCode.GDShopTileObjects2.length = 0;
gdjs.ShopCode.GDShopTileObjects3.length = 0;
gdjs.ShopCode.GDShopTileObjects4.length = 0;
